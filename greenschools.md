...
This post contains a summary of school work I completed to explore the potential for conducting a investigation into school campus greenery and performance, using exclusively open-source geospatial tools. I went on to complete a full analysis using a combination of open-source and proprietary tools. I'll share the results of that work in another post.
